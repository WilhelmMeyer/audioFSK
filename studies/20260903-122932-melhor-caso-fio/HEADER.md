...
- **Quando:** 2026-09-03 12:29:32  (campanha de 3.8 min)
...
Canal deliberadamente BOM: alto-falante interno com fio, ganho 0.20 escolhido pela varredura anterior, sem saturacao (pico 0.34). O contraponto do corpus degradado de proposito. A pergunta aqui nao e se a varredura de sincronismo melhora a media -- num canal limpo ela nao precisa -- e sim se ela continua eliminando o colapso ocasional do gate.

## Resultado

| repeat | n | blocos (gate) | blocos (varredura) | bits (gate) | bits (varredura) | periodo |
|---|---|---|---|---|---|---|
| 1 | 12 | 1/12 | 11/12 | 95.4% | 92.6% | 480.00 |
| 2 | 12 | 2/12 | 11/12 | 95.5% | 91.3% | 480.00 |

Comparacao pareada, mesmo audio nas duas colunas: a varredura leu mais bits que o gate em 1 de 24 gravacoes.

Nivel recebido: rms 0.081, pico 0.38 (maior 0.42).
...
```bash
./venv/bin/python study.py --rescore studies/20260903-122932-melhor-caso-fio
```
